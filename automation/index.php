...
function runDashboard(): int
{
    ...
    $dashboard = new \InterviewBank\Automation\StatisticsDashboard();
...
function runCrossRef(): int
{
    ...
    $mapper = new \InterviewBank\Automation\CrossReferenceMapper();
...
function runSearchIndex(): int
{
    ...
    $generator = new \InterviewBank\Automation\SearchIndexGenerator();
